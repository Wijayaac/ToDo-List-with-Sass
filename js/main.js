...
const initApp = () => {
    ...
    clearItems.addEventListener("click", (event) => {
        ...
        if (list.length) {
            const confirmed = confirm("Are you sure want to clear all list ?");
            if (confirmed) {
                toDoList.clearList();
...
const updateScreenReaderConfirmation = (newEntryText, actionVeb) => {
    document.getElementById("confirmation").textContent = `${newEntryText} ${actionVeb}.`;
}